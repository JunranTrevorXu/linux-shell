...
{
       0,    35,    35,    39,    40,    43,    47,    52,    53,    54,
      58,    62,    66,    72,    75,    81,    89,    92,    96,   102,
     122,   132,   133,   137,   142,   146,   154,   162,   171
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LESS", "A", "GG", "GA", "GGA", "PIPE", "EX", "$accept", "goal",
  "commands", "command", "simple_command", "background", "EXIT",
  "pipe_list", "command_and_args", "argument_list", "pipe", "argument",
  "command_word", "iomodifier_opts", "iomodifier_opt", YY_NULLPTR
};
#endif
...
{
       1,    -1,    -4,    -4,    -4,     8,     0,    -4,    -4,    -4,
      -3,    -4,    -4,    -4,    -4,    -4,    -4,     7,    10,     9,
      -4,    13,    19,    -4,    20,    21,    22,     5,    -4,    -4,
      -4,    -4,    -4,    -4,    -4,    -4,    -4
};
...
{
       0,     0,    20,     7,    12,     0,     0,     3,     5,     9,
      22,    13,    17,     8,     1,     4,    18,     0,    11,    15,
      14,     0,     0,    10,     0,     0,     0,     0,    21,    19,
      16,    23,    24,    25,    26,    27,     6
};
...
{
      -2,     1,     1,     2,     2,    13,     3,     3,    14,    16,
       2,    36,    29,     4,     4,    21,    31,    22,    23,    24,
      25,    26,    32,    33,    34,    35,     0,     0,    20,    15
};

static const yytype_int8 yycheck[] =
{
       0,     1,     1,     3,     3,     6,     6,     6,     0,    12,
       3,     6,     3,    13,    13,     5,     3,     7,     8,     9,
      10,    11,     3,     3,     3,     3,    -1,    -1,    17,     6
};
...
{
       0,     1,     3,     6,    13,    15,    16,    17,    18,    20,
      21,    22,    26,     6,     0,    17,    12,    24,    27,    23,
      22,     5,     7,     8,     9,    10,    11,    19,    28,     3,
      25,     3,     3,     3,     3,     3,     6
};
...
#line 102 "shell.y" /* yacc.c:1646  */
    {
	       ...
	       char * s = strdup((yyvsp[0].string_val));
	       char dest[1024];
...
#line 137 "shell.y" /* yacc.c:1646  */
    {
		...
		else Command::_currentCommand._outFile = (yyvsp[0].string_val);
	}
